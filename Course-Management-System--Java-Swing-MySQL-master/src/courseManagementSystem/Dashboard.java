...
public class Dashboard extends JFrame {
	...
	public Dashboard(DbManager db, String role, String name) {
		...
		JLabel byelb = new JLabel("GOOD BYEin  ");
		byelb.setForeground(new Color(255, 128, 0));
		byelb.setFont(new Font("JetBrains Mono", Font.BOLD, 12));
		byelb.setBounds(22, 768, 153, 14);
		panel.add(byelb);
		
		JLabel lblCourseManagement = new JLabel("@2025 Course Management System By Muzammil and Hadi");
		...
		JLabel wahUniLogo = new JLabel("");
		wahUniLogo.setIcon(new ImageIcon(Dashboard.class.getResource("/pics/wahuni.png")));
		wahUniLogo.setBounds(10, 0, 167, 85); // Adjust size/position as needed
		panel.add(wahUniLogo);
	}
}
